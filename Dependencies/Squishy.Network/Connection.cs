...
namespace Squishy.Network
{
	...
	public class Connection
	{
		...
		/// Binds to the given bindAddr, if specified.
		/// </summary>
		public virtual void BeginConnect(IPEndPoint addr, IPEndPoint bindAddr = null)
		{
		...
		/// </summary>
		public virtual void BeginConnect(string addr, int port, IPEndPoint bindAddr = null)
		{
			...
			if (point != null)
			{
				BeginConnect(remoteEndPoint, bindAddr);
			}
		}
